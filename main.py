                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img src="{url_for('static', filename='image/vid_mars_1.png')}" class="d-block w-100" alt="1234">
                                </div>
                                <div class="carousel-item">
                                  <img src="{url_for('static', filename='image/vid_mars_2.png')}" class="d-block w-100" alt="9876">
                                </div>
                                <div class="carousel-item">
                                  <img src="{url_for('static', filename='image/vid_mars_3.png')}" class="d-block w-100" alt="6487t5">
                                </div>
                              </div>
